...
class DataSource(object):
    def __init__(self):
        ...
        train_images  = train_images.reshape((OUTSIZE*Samplesize,28,28,1))
        test_images = test_images.reshape((OUTSIZE*TestS,28,28,1))
...
class Train:
    ...
    def train(self):
        ...
        self.cnn.model.save('./model/normalcal_cnn.h5')
